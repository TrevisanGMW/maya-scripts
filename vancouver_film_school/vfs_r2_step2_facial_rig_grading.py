"""
 ...
 To Do:
    ...
    Update name of the side ui controls (old)
    Recreate "All Common Patches" function
    Recreate "Brute Force Naming" function
...
gt_grading_settings = { 'keyframes_interval' : 4,
...
def build_gui_gt_grader_script():
    ...
    cmds.button(l='All Common Patches', h=30, bgc=footer_buttons_color, c=lambda args: apply_all_common(), en=False)
    ...
    cmds.button(l='Brute Force Naming', h=30, bgc=footer_buttons_color, c=lambda args: brute_force_naming(), en=False)
    ...
    def reset_viewport():
        ...
        try:
            ...
            for each_panel in panel_list:
                ...
                cmds.modelEditor(each_panel, e=1, displayTextures=0)
...
def joint_placement_skinning():
    ...
    facial_ctrls = ['head_ctrl', 'head_Ctrl', 'headCtrl']

    for ctrl in facial_ctrls:
            try:
                attrs = cmds.listAttr(ctrl, userDefined=True)
                for attr in attrs:
                    #try:
                    print(attr)
    ...
    # Adjust Viewport Visibility Settings
    try:
        panel_list = cmds.getPanel(type="modelPanel")
        ...
        for each_panel in panel_list:
            cmds.modelEditor(each_panel, e=1, polymeshes=1)
            cmds.modelEditor(each_panel, e=1, joints=1)
            cmds.modelEditor(each_panel, e=1, smoothShaded=1)
    except:
        pass
...
def controls_side_ui_connection():
    ...
    if not button_status:
        ...
        # Adjust Size of the timeline
        keyframes_interval = gt_grading_settings.get('keyframes_interval')
        cmds.playbackOptions(minTime=0, max = (keyframes_interval * 83))
        ...
        # Hide Skeleton
        for obj in ['skeleton', 'skeleton_grp', 'bones', 'root_jnt']:
            if cmds.objExists(obj):
                try:
                    cmds.setAttr(obj + '.v', 0)
                except:
        ...
        keyframe_list(to_key, 1, 'translateY', (keyframes_interval * 3))
        keyframe_list(to_key, -1, 'translateY', (keyframes_interval * 4))
        ...
        keyframe_list(to_key, 1, 'translateY', (keyframes_interval * 7))
        keyframe_list(to_key, -1, 'translateY', (keyframes_interval * 8))
        ...
        keyframe_list(to_key, 1, 'translateY', (keyframes_interval * 11))
        keyframe_list(to_key, -1, 'translateY', (keyframes_interval * 12))
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 13))
        # TX
        keyframe_list(to_key, 0, 'translateX', (keyframes_interval * 14))
        keyframe_list(to_key, 1, 'translateX', (keyframes_interval * 15))
        keyframe_list(to_key, 1, 'translateX', (keyframes_interval * 16))
        ...
        keyframe_list(to_key, 1, 'translateY', (keyframes_interval * 18))
        keyframe_list(to_key, -1, 'translateY', (keyframes_interval * 20))
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 22))
        
        # Main Eyebrow Controls
        to_key = ['right_mainBrow_ctrl', 'left_mainBrow_ctrl', 'left_mainbrow_ctrl','right_mainbrow_ctrl']
        # TY
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 22))
        keyframe_list(to_key, 2, 'translateY', (keyframes_interval * 24))
        keyframe_list(to_key, -2, 'translateY', (keyframes_interval * 26))
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 28))
        ...
        # TY
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 28))
        keyframe_list(to_key, -10, 'translateY', (keyframes_interval * 30))
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 32))
        
        to_key = ['right_eyelid_close_Ctrl', 'right_eyelid_close_ctrl', 'right_eyelid_closeCtrl']
        
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 32))
        keyframe_list(to_key, -10, 'translateY', (keyframes_interval * 33))
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 34))
        
        to_key = ['left_eyelid_close_Ctrl', 'left_eyelid_close_ctrl', 'left_eyelid_closeCtrl']
        
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 34))
        keyframe_list(to_key, -10, 'translateY', (keyframes_interval * 35))
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 36))
        

        # mainMouth
        to_key = ['mainMouth_ctrl', 'main_mouth_ctrl', 'main_Mouth_ctrl','mainMouth_Ctrl','mainMouthCtrl']
        # TY
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 36))
        keyframe_list(to_key, 1, 'translateY', (keyframes_interval * 37))
        keyframe_list(to_key, -1, 'translateY', (keyframes_interval * 38))
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 39))
        
        # upper and lower lip
        to_key = ['main_upperLip_ctrl', 'mainUpperLip_ctrl', 'main_UpperLip_ctrl','main_upperLip_Ctrl','main_upperLipCtrl']
        # TY
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 39))
        keyframe_list(to_key, 1, 'translateY', (keyframes_interval * 40))
        #keyframe_list(to_key, -1, 'translateY', (keyframes_interval * 41))
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 41))
        
        to_key = ['main_lowerLip_ctrl', 'mainLowerLip_ctrl', 'main_LowerLip_ctrl','main_lowerLip_Ctrl','main_lowerLipCtrl']
        # TY
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 41))
        #keyframe_list(to_key, 1, 'translateY', (keyframes_interval * 43))
        keyframe_list(to_key, -1, 'translateY', (keyframes_interval * 42))
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 43))
        
        
        
        # Smaller Controls
        to_key = ['right_cornerLip_ctrl', 'right_cornerLipCtrl']
        
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 43))
        keyframe_list(to_key, 2, 'translateY', (keyframes_interval * 44))
        keyframe_list(to_key, -2, 'translateY', (keyframes_interval * 45))
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 46))
        
        to_key = ['right_upperOutLip_ctrl', 'right_upperOutLipCtrl']
        
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 46))
        keyframe_list(to_key, 2, 'translateY', (keyframes_interval * 47))
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 48))
        
        to_key = ['right_lowerOutLip_ctrl', 'right_lowerOutLipCtrl']
        
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 48))
        keyframe_list(to_key, -2, 'translateY', (keyframes_interval * 49))
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 50))
        
        to_key = ['mid_upperLip_ctrl', 'mid_upperLipCtrl']
        
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 50))
        keyframe_list(to_key, 2, 'translateY', (keyframes_interval * 51))
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 52))
        
        to_key = ['mid_lowerLip_ctrl', 'mid_lowerLipCtrl']
        
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 52))
        keyframe_list(to_key, -2, 'translateY', (keyframes_interval * 53))
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 54))
        ...
        to_key = ['left_lowerOutLip_ctrl', 'left_lowerOutLipCtrl']
        
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 48))
        keyframe_list(to_key, -2, 'translateY', (keyframes_interval * 49))
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 50))
       
        to_key = ['left_upperOutLip_ctrl', 'left_upperOutLipCtrl']
        ...
        to_key = ['left_cornerLip_ctrl', 'left_cornerLipCtrl']
        ...
        # Jaw
        to_key = ['jaw_ctrl', 'jawPivot_ctrl', 'jawCtrl']
        
        keyframe_list(to_key, 0, 'rz', (keyframes_interval * 54))
        keyframe_list(to_key, 30, 'rz', (keyframes_interval * 56))
        keyframe_list(to_key, 0, 'rz', (keyframes_interval * 58))
        
        
        # Head
        to_key = ['head_ctrl', 'headCtrl']
        
        keyframe_list(to_key, 0, 'rz', (keyframes_interval * 58))
        keyframe_list(to_key, 30, 'rz', (keyframes_interval * 60))
        keyframe_list(to_key, -30, 'rz', (keyframes_interval * 64))
        keyframe_list(to_key, 0, 'rz', (keyframes_interval * 65))
        keyframe_list(to_key, 0, 'rx', (keyframes_interval * 65))
        keyframe_list(to_key, 30, 'rx', (keyframes_interval * 67))
        keyframe_list(to_key, -30, 'rx', (keyframes_interval * 69))
        keyframe_list(to_key, 0, 'rx', (keyframes_interval * 71))
        

        # Eyes Aim
        to_key = ['main_eye_Ctrl', 'main_eye_ctrl', 'main_eyeCtrl']
        # TY
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 71))
        keyframe_list(to_key, 15, 'translateY', (keyframes_interval * 72))
        keyframe_list(to_key, -15, 'translateY', (keyframes_interval * 73))
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 74))
        # TX
        keyframe_list(to_key, 0, 'translateX', (keyframes_interval * 74))
        keyframe_list(to_key, 15, 'translateX', (keyframes_interval * 75))
        keyframe_list(to_key, -15, 'translateX', (keyframes_interval * 76))
        keyframe_list(to_key, 0, 'translateX', (keyframes_interval * 77))
        
        to_key = ['left_eye_Ctrl', 'left_eye_ctrl', 'left_eyeCtrl', 'right_eye_Ctrl', 'right_eye_ctrl', 'right_eyeCtrl']
        # TY
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 77))
        keyframe_list(to_key, 15, 'translateY', (keyframes_interval * 78))
        keyframe_list(to_key, -15, 'translateY', (keyframes_interval * 79))
        keyframe_list(to_key, 0, 'translateY', (keyframes_interval * 80))
        # TX
        keyframe_list(to_key, 0, 'translateX', (keyframes_interval * 80))
        keyframe_list(to_key, 15, 'translateX', (keyframes_interval * 81))
        keyframe_list(to_key, -15, 'translateX', (keyframes_interval * 82))
        keyframe_list(to_key, 0, 'translateX', (keyframes_interval * 83))
    ...
    if not button_status:
        ...
        for ctrl in facial_ctrls:
                try:
                    ...
                    for attr in attrs:
                        try:
                            if 'visibility' in attr.lower() and 'blend' not in attr.lower():
                                cmds.setAttr(ctrl + '.' + attr, 0)
                        except:
                           pass
                except:
        ...
        stretch_squash_ctrl = ['']
        all_ctrls_shapes = cmds.ls(type='nurbsCurve')
        for crv_shape in all_ctrls_shapes:
            crv_short_name = crv_shape.split('|')[-1] 
            if 'stretch' in crv_short_name and 'ctrl' in crv_short_name:
                stretch_squash_ctrl = cmds.listRelatives(crv_shape, ap=True)

        
        # Head StretchSquash TY
        keyframe_list(stretch_squash_ctrl, 0, 'ty', 0)
        keyframe_list(stretch_squash_ctrl, 10, 'ty', (keyframes_interval * 2))
        keyframe_list(stretch_squash_ctrl, -10, 'ty', (keyframes_interval * 6))
        keyframe_list(stretch_squash_ctrl, 0, 'ty', (keyframes_interval * 8))
        # TX
        keyframe_list(stretch_squash_ctrl, 0, 'tx', 0)
        keyframe_list(stretch_squash_ctrl, 10, 'tx', (keyframes_interval * 2))
        keyframe_list(stretch_squash_ctrl, -10, 'tx', (keyframes_interval * 6))
        keyframe_list(stretch_squash_ctrl, 0, 'tx', (keyframes_interval * 8))
        
        # TX
        keyframe_list(stretch_squash_ctrl, 0, 'tz', 0)
        keyframe_list(stretch_squash_ctrl, 10, 'tz', (keyframes_interval * 2))
        keyframe_list(stretch_squash_ctrl, -10, 'tz', (keyframes_interval * 6))
        keyframe_list(stretch_squash_ctrl, 0, 'tz', (keyframes_interval * 8))
        
        current_timing = (keyframes_interval * 8) # Last Stretch Squash Pose
        
        
        visime_ctrls = ['visemes_one_ctrl', 'visemes_two_ctrl', 'visemes_three_ctrl', 'visemes_four_ctrl']
        visime_extra_ctrls = ['visemes_five_ctrl', 'visemes_six_ctrl', 'visemes_seven_ctrl', 'visemes_eight_ctrl']
        bonus_ctrls = ['bonus_one_ctrl', 'bonus_two_ctrl', 'bonus_three_ctrl', 'bonus_four_ctrl']
        possible_bs_ctrls = ['viseme_one_ctrl', 'viseme_two_ctrl', 'viseme_three_ctrl', 'viseme_four_ctrl', 'viseme_five_ctrl', 'viseme_six_ctrl', 'viseme_seven_ctrl', 'viseme_eight_ctrl']
        
        bs_ctrls = visime_ctrls + visime_extra_ctrls + bonus_ctrls + possible_bs_ctrls
        
        for ctrl in bs_ctrls:
            if cmds.objExists(ctrl):
                keyframe_list([ctrl], 0, 'ty', current_timing)
                current_timing += keyframes_interval * 3
                keyframe_list([ctrl], 10, 'ty', current_timing)
                current_timing += keyframes_interval * 3
                keyframe_list([ctrl], 0, 'ty', current_timing)
    
    
        # Adjust Size of the timeline
        cmds.playbackOptions(minTime=0, max = current_timing)
