"""
 Load Redshift Script - This script will try to load the plugin Redshift in case it's not already loaded.
 ...
 3. If you ever need to use Redshift, just click on the shelf button
